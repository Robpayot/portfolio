...
},{"./managers/AppManager":4,"gsap":9,"modernizr":7}],2:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // import SoundManager from '../managers/SoundManager';
...
var EmitterManager = function EmitterManager() {
	_classCallCheck(this, EmitterManager);
...
},{"../components/Graphic3D":2,"../components/GraphicBars":3}],7:[function(require,module,exports){
(function (global){
